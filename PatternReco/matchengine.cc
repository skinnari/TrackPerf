...
void matchengine(){
  ...
  c3->cd(1);
  gPad->SetLogy();
  plotHist(hist_L1regionpass,0.05,ncut1,ncut2,true);
  hist_L1region->Draw("same");
  hist_L1regionpass->SetLineColor(kBlue);
  hist_L1regionpass->Draw("same");

  c3->cd(2);
  gPad->SetLogy();
  plotHist(hist_L2regionpass,0.05,ncut1,ncut2,true);
  hist_L2region->Draw("same");
  hist_L2regionpass->SetLineColor(kBlue);
  hist_L2regionpass->Draw("same");

  c3->cd(3);
  gPad->SetLogy();
  plotHist(hist_L3regionpass,0.05,ncut1,ncut2,true);
  hist_L3region->Draw("same");
  hist_L3regionpass->SetLineColor(kBlue);
  hist_L3regionpass->Draw("same");

  c3->cd(4);
  gPad->SetLogy();
  plotHist(hist_L4regionpass,0.05,ncut1,ncut2,true);
  hist_L4region->Draw("same");
  hist_L4regionpass->SetLineColor(kBlue);
  hist_L4regionpass->Draw("same");

  c3->cd(5);
  gPad->SetLogy();
  plotHist(hist_L5regionpass,0.05,ncut1,ncut2,true);
  hist_L5region->Draw("same");
  hist_L5regionpass->SetLineColor(kBlue);
  hist_L5regionpass->Draw("same");

  c3->cd(6);
  gPad->SetLogy();
  plotHist(hist_L6regionpass,0.05,ncut1,ncut2,true);
  hist_L6region->Draw("same");
  ...
  c4->cd(1);
  gPad->SetLogy();
  plotHist(hist_D1regionpass,0.05,ncut1,ncut2,true);
  hist_D1region->Draw("same");
  hist_D1regionpass->SetLineColor(kBlue);
  hist_D1regionpass->Draw("same");

  c4->cd(2);
  gPad->SetLogy();
  plotHist(hist_D2regionpass,0.05,ncut1,ncut2,true);
  hist_D2region->Draw("same");
  hist_D2regionpass->SetLineColor(kBlue);
  hist_D2regionpass->Draw("same");

  c4->cd(3);
  gPad->SetLogy();
  plotHist(hist_D3regionpass,0.05,ncut1,ncut2,true);
  hist_D3region->Draw("same");
  hist_D3regionpass->SetLineColor(kBlue);
  hist_D3regionpass->Draw("same");

  c4->cd(4);
  gPad->SetLogy();
  plotHist(hist_D4regionpass,0.05,ncut1,ncut2,true);
  hist_D4region->Draw("same");
  hist_D4regionpass->SetLineColor(kBlue);
  hist_D4regionpass->Draw("same");

  c4->cd(5);
  gPad->SetLogy();
  plotHist(hist_D5regionpass,0.05,ncut1,ncut2,true);
  hist_D5region->Draw("same");
